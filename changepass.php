...
function printPassFields($id) {
	...
	echo "<form name='form1' method='post' action='changepass.php'>";
	echo "<center>";
	...
	echo "<td scope='col'><input id='score' type='text' disabled='disabled' size='4'></input> (mindestens 60%)</td></tr>";
	echo "</table>";
	echo "<div style='font-size: 8pt;'><b>Hinweis:</b> Mischen von Kleinbuchstaben, Großbuchstaben, Zahlen und Sonderzeichen und die Passwortlänge erhöht dessen Stärke</div>";
	echo "<br/>";
