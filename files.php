...
function printUploadLinks() {
	echo "<center>";
	echo "<a href='".$_SERVER['PHP_SELF']."?action=java'>Java Dateiupload</a>";
	echo "&nbsp;&nbsp;&nbsp;";
	echo "<a href='".$_SERVER['PHP_SELF']."?action=ftp'>FTP Dateiupload</a>";
	echo "</center>";
}

function printJavaUploader() {
	echo "<iframe src='uploader/' width='100%' height='95%' border='0' frameborder='0'><p>Dieser Browser kann leider keine I-frames anzeigen</p></iframe>";
}
